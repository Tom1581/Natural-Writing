...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'undetectable aiwriting',
    'undetectable aiwiring',
    'aiwriting undetectable',
    'ai writing ai detectable',
    'ai detectable writing',
    'ai dedectable ai writing',
    'ai dedectable aiwiring',
    'ai undetectable writing',
    ...
    'undetectable chatgpt',
    'undetectablegpt',
    'undetectable gpt',
    'undetectable gptzero',
    'undetectablegptzero',
    'gptzero undetectable',
    'gpt zero undetectable',
    'turnitin undetectable',
    'scribbr undetectable',
